...
# Step 2: Train modality-aware scales and evaluate (W4A6 configuration)
# This script trains the modality-aware quantization scales using MAS-Quant algorithm
...
ABITS=6  # Activation quantization bits
...
echo "========================================="
echo "Training MAS-Quant W${WBITS}A${ABITS}"
echo "========================================="
